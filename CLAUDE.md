...
- **武陵：** v5.0 起 1 行 7 + 第 2 行 4 格，共 11 項；item_id 13-23（v3.0~v4.x 為 7+1、13-20；v2.0~v2.1.1 為 1 行 7 格、13-19）；顯示順序每天隨機，靠 OCR 名稱 + fuzzy match 對應
- **每日配額上限：** 谷地 +320 / 上限 960；武陵 +200 / 上限 400（v5.0 7/16 起；6/05~7/15 為 +170/340；5/17~6/04 為 +140/280；4/17~5/16 為 +125/250；4/17 前為 65/130）
