...
| **自動更新** | 每次啟動時自動檢查並更新到最新版；更新後與點擊網頁版本可看到目前版本與更新紀錄 |
...
跟 F2 是**同一個畫面**：物資調度 →「彈性需求物資」分頁，上半部的**「目前持有」**區按 **F4**，系統會辨識持有的物資與買入價並記錄下來。
...
辨識完成會在最下方的顯示**「囤貨持有」**區，會列出持有清單，包含買入價、好友最高價、囤貨利潤與建議賣出日。實際賣掉後按「賣出」。
