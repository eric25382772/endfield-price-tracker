...
進入**物資調度**畫面（能看到「目前持有」區），按 **F4**。系統會辨識你手上持有的物資與買入價，記錄成囤貨。

記錄完成後回網頁重新整理，囤貨區就會列出持有清單、預估利潤與建議賣出日。

<!-- TODO 待補截圖 ①：物資調度畫面（畫面上要看得到「目前持有」區），在這裡按 F4 -->
<!-- 補圖時貼在這裡，格式：
<p align="center">
  <img src="截圖網址" width="820" alt="物資調度畫面"><br>
  <sub>① 在物資調度畫面按 F4</sub>
</p>
-->

<!-- TODO 待補截圖 ②：網頁上的囤貨區辨識結果 -->
<!-- 補圖時貼在這裡，格式：
<p align="center">
  <img src="截圖網址" width="820" alt="囤貨紀錄"><br>
  <sub>② 網頁囤貨區出現持有清單與建議賣出日</sub>
</p>
-->
